 ...
 *
 * The bridge daemon pins four BPF maps under /sys/fs/bpf/:
 *
...
#ifndef __GPU_EBPF_BRIDGE_TYPES_H
#define __GPU_EBPF_BRIDGE_TYPES_H
 ...
 * HGX system minus an order of magnitude of headroom. */
 ...
 * last_update_ns against bpf_ktime_get_ns() and treat data older than
 * ~2x the bridge's poll interval as stale. */
struct gpu_meta {
	__u32 schema_version;
	__u32 n_devices;
	__u64 last_update_ns;     /* CLOCK_MONOTONIC */
	__u32 helper_pid;
	__u32 _reserved;
};
...
#endif /* __GPU_EBPF_BRIDGE_TYPES_H */
